...
public class WorksHistoryFragment extends Fragment
{
    ...
    // TODO Viewmodel otrzymuje list<Work> -- viewModel.workList.observe
    ...
    public String getResultFromExternalDb()
    {
    ...
    public List<Work> createListFromJson(String jsonString)
    {
    ...
    public List<Work> fillArrayFrom(JSONArray jsonArray) throws JSONException
    {
